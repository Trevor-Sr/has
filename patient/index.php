        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
                        ...
                        <div class="abc scroll" style="height: 250px;padding: 0;margin: 0;">
                            <table width="85%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $today = date("Y-m-d"); // Assuming $today represents the current date
            ...
            <td colspan="4">
                ...
                <center>
                    ...
                    <a class="non-style-link" href="schedule.php"><button class="login-btn btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Channel a Doctor &nbsp;</font></button></a>
                </center>
                <br><br><br><br>
            </td>
          </tr>';
