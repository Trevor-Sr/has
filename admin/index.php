...
<body>
    ...
    <div class="container">
        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-appoinment">
                <a href="appointment_audit_trail.php" class="non-style-link-menu">
                    <div>
                        <p class="menu-text">Appt_audit_trail</p>
                    </div>
                </a>
            </td>
        </tr>
        <tr class="menu-row">
            <td class="menu-btn menu-icon-appoinment">
                <a href="updates.php" class="non-style-link-menu">
                    <div>
                        <p class="menu-text">Updates</p>
                    </div>
                </a>
            </td>
        </tr>
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
            ...
            <tr>
                ...
                <td width="15%">
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        ...
                        // Check if the 'patient' table exists before executing the query
                        if ($database->query("SHOW TABLES LIKE 'patient'")->num_rows > 0) {
                            $patientrow = $database->query("SELECT * FROM patient;");
                        } else {
                            echo "Error: The 'patient' table does not exist in the database.";
                            // Handle the error or exit the script gracefully
                        }

                        // Similarly, check for other tables before executing their respective queries
                        if ($database->query("SHOW TABLES LIKE 'doctor'")->num_rows > 0) {
                            $doctorrow = $database->query("SELECT * FROM doctor;");
                        } else {
                            echo "Error: The 'doctor' table does not exist in the database.";
                            // Handle the error or exit the script gracefully
                        }

                        if ($database->query("SHOW TABLES LIKE 'appointment'")->num_rows > 0) {
                            $appointmentrow = $database->query("SELECT * FROM appointment WHERE appodate >= '$today';");
                        } else {
                            echo "Error: The 'appointment' table does not exist in the database.";
                            // Handle the error or exit the script gracefully
                        }

                        if ($database->query("SHOW TABLES LIKE 'schedule'")->num_rows > 0) {
                            $schedulerow = $database->query("SELECT * FROM schedule WHERE scheduledate = '$today';");
                        } else {
                            echo "Error: The 'schedule' table does not exist in the database.";
                            // Handle the error or exit the script gracefully
                        }
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div>
                                            <div class="h1-dashboard">
                                                <?php echo isset($patientrow) && $patientrow instanceof \mysqli_result ? $patientrow->num_rows : 0; ?>
                                            </div><br>
                                    ...
                                    <div class="abc scroll" style="height: 200px;">
                                        <table width="85%" class="sub-table scrolldown" border="0">
                                            ...
                                            <tbody>
                                                ...
                                                // Check if the main SQL query is valid and the table exists before executing it
                                                if ($database->query("SHOW TABLES LIKE 'appointment'")->num_rows > 0) {
                                                    $result = $database->query($sqlmain);
                                                } else {
                                                    echo "Error: The main table does not exist in the database.";
                                                    // Handle the error or exit the script gracefully
                                                }
            ...
            <td colspan="3">
                ...
                <td>' . substr($title, 0, 15) . '</td>
                                                    ...
                                                    echo "Error: Invalid result set or the table does not exist.";
                                                    // Handle the error or exit the script gracefully
                                                }
